...
class TocMachine(GraphMachine):
    ...
    def is_going_to_Excited(self, update):
        text = update.message.text
        return text.lower() == 'relax'

    def is_going_to_Tired(self, update):
        text = update.message.text
        return (text.lower() == 'take a shower' or text.lower() == 'study more')
    ...
    def on_enter_Bored(self, update):
        update.message.reply_text("If you feel bored, you can try to 'sail', 'study', or 'relax'")
    ...
    def on_enter_Excited(self, update):
        ...
        update.message.reply_text("Do you still want to 'relax'?\nOr you want to 'study'?")
    ...
    def on_enter_Sleeping(self, update):
        update.message.reply_text("go to sleep~Zzz\nif you 'feel bored' again, just let me give you suggestion.")
